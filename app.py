...
#
# def get_route_from_osrm(start_lat, start_lng, end_lat, end_lng):
#     """Return list of (lat, lng) tuples or empty list"""
#     if None in (start_lat, start_lng, end_lat, end_lng):
#         return []
#     try:
#         url = f"https://router.project-osrm.org/route/v1/driving/{start_lng},{start_lat};{end_lng},{end_lat}?overview=full&geometries=geojson"
...
#
#     if not route_coords:
#         return jsonify({"route": [], "message": "No route found"}), 200
#
#     # Optional: add mock crowd data
#     crowd_points = [{"latitude": lat, "longitude": lng, "count": 0} for lat, lng in route_coords]
#
#     return jsonify({
#         "route": route_coords,
#         "crowd": crowd_points
